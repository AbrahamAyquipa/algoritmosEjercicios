...
void Entidad::setW(int w) { this->w = w; }
void Entidad::setH(int h) {this->h = h; }
void Entidad::setRow(int r) { row = r; }
void Entidad::setCol(int c) { col = c; }
void Entidad::setMaxRow(int r) { maxRow = r; }
void Entidad::setMaxCol(int c) { maxCol = c; }
void Entidad::setActive(bool state) { active = state; }
void Entidad::setOrientacion(direccion d) { orientacion = d; }
...
int Entidad::getRow() { return row; }
int Entidad::getCol() { return col; }
int Entidad::getMaxRow() { return maxRow; }
int Entidad::getMaxCol() { return maxCol; }
bool Entidad::getActive() { return active; }

direccion Entidad::getOrientacion() { return orientacion; }
Rectangle Entidad::getArea() { return Rectangle(x, y, w, h); }
Rectangle Entidad::getNextArea() { return Rectangle(x + dx, y + dy, w, h); }
